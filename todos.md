...
stage: 
- stage1: for some basic features of karmada dashboard, provide instructions to install karmada dashboard on karmada-host cluster, implementing essential features like management of cluster、 propagationpolicy、overridepolicy and kubernetes resources which are supported by karmada
- stage2: improve experience，including DX、UX, like implementing more powerful features like basic config、advanced config for dashboard, design addon system, improve the ecosystem of dashboard, make the integration with cloud native components more easily.
